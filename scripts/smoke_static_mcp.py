...
def main() -> int:
    ...
    assert "freecad_gui_view_orientation_set" in tool_names
    assert "freecad_gui_visibility_ensure" in tool_names
    ...
    assert "freecad_partdesign_fillet" in tool_names
    ...
    assert "freecad_worker_partdesign_fillet" in tool_names
