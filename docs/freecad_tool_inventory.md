...
| P1 | `freecad.sketcher` | `freecad_sketch_create`, `freecad_sketch_add_geometry`, `freecad_sketch_add_constraint`, `freecad_sketch_add_profile`, `freecad_sketch_profile_create`, `freecad_sketch_profile_validate`, `freecad_sketch_edit_geometry`, `freecad_sketch_edit_constraints`, `freecad_sketch_transform`, `freecad_sketch_auto_constrain`, `freecad_sketch_validate` | Sketcher module exposes 101 scanned commands. |
