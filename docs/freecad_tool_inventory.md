...
| P1 | `freecad.partdesign` | `freecad_partdesign_body_create`, `freecad_partdesign_datum_plane_create`, `freecad_partdesign_pad`, `freecad_partdesign_pocket`, `freecad_partdesign_hole`, `freecad_partdesign_revolution`, `freecad_partdesign_groove` | PartDesign module exposes 41 scanned commands and requires Body/datum/plane attachment for Pad/Pocket/Hole/Revolution/Groove workflows. |
