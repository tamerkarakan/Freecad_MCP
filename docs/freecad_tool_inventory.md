...
| P0 | `freecad.object` | `freecad_object_list`, `freecad_object_get`, `freecad_object_set_properties`, `freecad_object_rename_label`, `freecad_object_delete`, `freecad_object_fit_view` | MCP clients need deterministic object inspection and user-visible naming instead of blind command execution. |
