...
| P1 | `freecad.partdesign` | `freecad_partdesign_body_create`, `freecad_partdesign_pad`, `freecad_partdesign_pocket` | PartDesign module exposes 41 scanned commands and requires Body/plane attachment for Pad workflows. |
