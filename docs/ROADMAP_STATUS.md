...
- Loop-based Sketcher profile builder/validator for pad-ready traced profiles, endpoint drift rejection, Part face validation, and no-cheat topology checks.
