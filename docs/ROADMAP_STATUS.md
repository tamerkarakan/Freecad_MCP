...
- PartDesign Body/datum/support attachment plus Datum Plane, Pad, Pocket, Hole, Revolution, Groove, and Additive Loft creation for Sketcher profiles that need the same Body + plane/support workflow FreeCAD GUI prompts for.
