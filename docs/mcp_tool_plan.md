...
| `freecad_worker_partdesign_body_create/datum_plane_create/pad/pocket/hole/revolution/groove/additive_loft/subtractive_loft/additive_pipe/subtractive_pipe` | Create Body-based datum, additive, subtractive, multi-sketch, and sweep PartDesign features in persistent worker documents. | PartDesign App API |
