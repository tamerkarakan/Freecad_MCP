...
| `freecad_worker_partdesign_body_create/pad/pocket` | Create Body-based additive/subtractive PartDesign features in persistent worker documents. | PartDesign App API |
