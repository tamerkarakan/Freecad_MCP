...
| `pro` | paid | 61 | `wheel`, `sdist`, `stdio-mcp-config`, `freecad-workbench-module` | `python-package`, `runtime-scripts`, `gui-bridge`, `workbench-module` |
| `studio` | paid | 119 | `wheel`, `sdist`, `stdio-mcp-config`, `freecad-workbench-module` | `python-package`, `runtime-scripts`, `persistent-worker`, `gui-bridge`, `workbench-module` |
| `team` | paid | 122 | `wheel`, `sdist`, `stdio-mcp-config`, `freecad-workbench-module`, `source-intelligence-docs` | `python-package`, `runtime-scripts`, `persistent-worker`, `gui-bridge`, `workbench-module`, `source-intelligence` |
