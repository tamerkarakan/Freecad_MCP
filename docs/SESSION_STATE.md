...
- `scripts/smoke_persistent_worker.py` now exercises Part, Sketcher connected closed chains, mesh, and Assembly flows in one long-lived FreeCADCmd worker session.
