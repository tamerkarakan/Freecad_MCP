...
- Static MCP resource coverage includes architecture, session state, testing, Sketcher capabilities, GUI attach planning, Workbench bridge setup, TechDraw/CAM/FEM planning, schemas, and inventory summary.
