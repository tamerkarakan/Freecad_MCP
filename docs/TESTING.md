...
- Unit guard for GUI bridge attach/call/detach/error handling, GUI primitive-create delegation, and Sketcher/PartDesign GUI state-reader delegation against a fake local HTTP bridge (`test_gui_bridge.py`).
