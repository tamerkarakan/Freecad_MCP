...
| `gui` | FreeCAD GUI attach, active document/view, selection, view-fit, and first live primitive creation. |
...
| Pro | `pro` | 59 | Adds GUI attach, Sketcher, PartDesign, mesh, and Assembly. |
| Studio | `studio` | 117 | Adds persistent worker sessions plus TechDraw, CAM, and FEM. |
| Team | `team` | 120 | Adds source-intelligence tools. |
