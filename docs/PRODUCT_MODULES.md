...
| `partdesign` | PartDesign Body, Pad, Pocket, and Hole typed tools. |
...
| Pro | `pro` | 68 | Adds GUI attach, Sketcher, PartDesign, mesh, and Assembly. |
| Studio | `studio` | 129 | Adds persistent worker sessions plus TechDraw, CAM, and FEM. |
| Team | `team` | 132 | Adds source-intelligence tools. |
