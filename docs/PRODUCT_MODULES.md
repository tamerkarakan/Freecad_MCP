...
| `partdesign` | PartDesign Body, Datum Plane, Pad, Pocket, Hole, Revolution, and Groove typed tools. |
...
| Pro | `pro` | 71 | Adds GUI attach, Sketcher, PartDesign, mesh, and Assembly. |
| Studio | `studio` | 135 | Adds persistent worker sessions plus TechDraw, CAM, and FEM. |
| Team | `team` | 138 | Adds source-intelligence tools. |
