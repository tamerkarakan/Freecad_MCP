...
| `partdesign` | PartDesign Body, Datum Plane, Pad, Pocket, Hole, Revolution, Groove, and Additive Loft typed tools. |
...
| Pro | `pro` | 72 | Adds GUI attach, Sketcher, PartDesign, mesh, and Assembly. |
| Studio | `studio` | 137 | Adds persistent worker sessions plus TechDraw, CAM, and FEM. |
| Team | `team` | 140 | Adds source-intelligence tools. |
