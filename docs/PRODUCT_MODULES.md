...
| Pro | `pro` | 75 | Adds GUI attach, Sketcher, PartDesign, mesh, and Assembly. |
| Studio | `studio` | 143 | Adds persistent worker sessions plus TechDraw, CAM, and FEM. |
| Team | `team` | 146 | Adds source-intelligence tools. |
