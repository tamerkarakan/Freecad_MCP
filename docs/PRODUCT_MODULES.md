...
| `partdesign` | PartDesign Body, Pad, Pocket, Hole, Revolution, and Groove typed tools. |
...
| Pro | `pro` | 70 | Adds GUI attach, Sketcher, PartDesign, mesh, and Assembly. |
| Studio | `studio` | 133 | Adds persistent worker sessions plus TechDraw, CAM, and FEM. |
| Team | `team` | 136 | Adds source-intelligence tools. |
