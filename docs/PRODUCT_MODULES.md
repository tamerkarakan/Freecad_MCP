...
| `partdesign` | PartDesign Body, Datum Plane, Pad, Pocket, Hole, Revolution, Groove, Additive/Subtractive Loft, Additive/Subtractive Pipe, and Fillet/Chamfer/Thickness/Draft dress-up typed tools, including multisection and auxiliary-spine Pipe options. |
...
| Pro | `pro` | 79 | Adds GUI attach, Sketcher, PartDesign, mesh, and Assembly. |
| Studio | `studio` | 151 | Adds persistent worker sessions plus TechDraw, CAM, and FEM. |
| Team | `team` | 154 | Adds source-intelligence tools. |
