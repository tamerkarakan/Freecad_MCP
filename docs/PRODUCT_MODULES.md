...
| `partdesign` | PartDesign Body, Datum Plane, Pad, Pocket, Hole, Revolution, Groove, Additive Loft, and Subtractive Loft typed tools. |
...
| Pro | `pro` | 73 | Adds GUI attach, Sketcher, PartDesign, mesh, and Assembly. |
| Studio | `studio` | 139 | Adds persistent worker sessions plus TechDraw, CAM, and FEM. |
| Team | `team` | 142 | Adds source-intelligence tools. |
