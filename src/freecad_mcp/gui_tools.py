        ...
        return [
            ...
            self._gui_tool(
                ...
                "Open an existing FreeCAD .FCStd document in the attached GUI session.",
                {
                    ...
                    "ensure_visible": {"type": "boolean", "default": True},
                    "visibility_scope": {"type": "string", "enum": ["final", "all_geometry", "all"], "default": "final"},
                },
                ["document_path"],
                "document_open",
            ),
            ...
            self._gui_tool(
                ...
                "Turn on visibility for the final display object or selected geometry in the active FreeCAD GUI document.",
                {
                    ...
                    "scope": {"type": "string", "enum": ["final", "all_geometry", "all"], "default": "final"},
                    "fit_view": {"type": "boolean", "default": True},
                    "select": {"type": "boolean"},
                },
                [],
