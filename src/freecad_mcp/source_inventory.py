...
def proposed_tool_families(commands: list[CommandRecord]) -> list[dict[str, object]]:
    ...
    return [
        ...
        },
        {
            ...
            "evidence": f"PartDesign module exposes {counts.get('PartDesign', 0)} scanned commands and requires Body/plane attachment for Pad/Pocket/Hole/Revolution/Groove workflows.",
        },
        {
