...
def proposed_tool_families(commands: list[CommandRecord]) -> list[dict[str, object]]:
    ...
    return [
        ...
        },
        {
            ...
            "evidence": "Parametric Sketch/PartDesign workflows need named Spreadsheet aliases bound into object properties and Sketcher dimension constraints such as Constraints[0].",
        },
        {
