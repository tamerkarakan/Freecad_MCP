...
def proposed_tool_families(commands: list[CommandRecord]) -> list[dict[str, object]]:
    ...
    return [
        ...
        },
        {
            ...
            "evidence": "GUI attach mode is required for opening generated documents in the live GUI, active view, viewport snapshots, preselection, picked points, selected edge/face state, user-visible labels, live Sketcher edit mode, PartDesign Body/Tip activation state, and task-panel observation.",
        },
        {
