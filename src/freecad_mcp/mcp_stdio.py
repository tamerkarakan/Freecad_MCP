            ...
            "messages": [
                {
                    ...
                    "content": {
                        ...
                        "text": (
                            ...
                            "parametric profiles. Treat helper/profile intent as native geometry plus constraint "
                            "fingerprint, not as a separate primitive family: rectangle is LineSegment geometry "
                            "with H/V constraints, regular polygon is line loop plus construction circle/"
                            ...
                            "construction_guides_only, rough_draft, or manufacturing_partdesign_model output, ask first or call "
                            ...
                            "If the image shows Sketcher constraint glyphs, dimensions, or blue construction geometry, "
                            ...
                            "If visible curves could be unsupported freeform/B-spline, circular arcs, or ellipses, ask for native_curve_intent. "
                            "B-spline/freeform profile creation is not supported: do not approximate it with many lines or polylines; "
                            "use construction_guides_only for blue guide geometry or ask for a supported arc/ellipse interpretation. "
            ...
            "messages": [
                {
                    ...
                    "content": {
                        ...
                        "text": (
                            ...
                            "mantiginin yeniden kurulmasi mi, uretilebilir PartDesign model mi, sadece mavi "
                            "construction/klavuz geometri mi, yoksa kaba taslak mi?' Map the answer to one of these modeling_strategy values: visual_trace, "
                            "editable_parametric_sketch, manufacturing_partdesign_model, "
                            "sketcher_constraint_rebuild, construction_guides_only, or rough_draft. Use freecad_modeling_strategy_intake "
                            ...
                            "or freecad_sketch_profile_create before changing geometry. If the screenshot shows "
                            "red dimensions/constraint glyphs or blue construction geometry, ask for a Sketcher "
                            "constraint rebuild/editable parametric sketch instead of silently choosing visual_trace. "
                            "If the screenshot shows B-spline/freeform control points or the curve family is unclear, ask "
                            "which native_curve_intent to set: supported circular arc, ellipse, mixed, or unsupported_freeform. "
                            "For unsupported_freeform, do not create a profile; at most create construction guides with "
                            "forbid_real_line_geometry=true and do not claim full-constraint or pad-ready status. "
